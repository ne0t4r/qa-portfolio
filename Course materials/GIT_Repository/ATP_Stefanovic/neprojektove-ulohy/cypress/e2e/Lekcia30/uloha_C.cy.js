...
describe('Zadanie_17.3.1_B práca s "Multi Step Form"', () => {
  beforeEach("passes", () => {
    ...
    cy.fixture("17.3.1_C.json").then(function (data) {
      this.data = data;
    });
  });
  it("Test", function () {
    ...
    cy.wrap(this.data).each((single) => {
      ...
      cy.get(".fw-textarea")
        .type(single.message)
        .should("have.value", single.message);
